...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SOAVEHICLEINFO_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SOAVEHICLEINFO_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "soavehicleinfo_common.h"
...
public:
    ...
    /// @brief Destructor
    virtual ~soaVehicleInfo() = default;
    /// @brief Delete copy constructor
    soaVehicleInfo(const soaVehicleInfo& other) = delete;
    /// @brief Delete copy assignment
    soaVehicleInfo& operator=(const soaVehicleInfo& other) = delete;
    /// @brief Move constructor
    soaVehicleInfo(soaVehicleInfo&& other) noexcept : mInterface(other.mInterface)
    {
    ...
    soaVehicleInfo& operator=(soaVehicleInfo&& other) noexcept
    {
...
private:
    ...
    const std::string kGetterCallSign = {"soaVehicleInfoGetter"};
    const std::string kNotifierCallSign = {"soaVehicleInfoNotifier"};
};
} /// namespace fields
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<SoaVehicleInfoProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<SoaVehicleInfoProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<SoaVehicleInfoProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<SoaVehicleInfoProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<SoaVehicleInfoProxy::HandleType> handleContainer;
    ...
    explicit SoaVehicleInfoProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , soaVehicleInfo(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~SoaVehicleInfoProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    SoaVehicleInfoProxy(SoaVehicleInfoProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    SoaVehicleInfoProxy& operator=(const SoaVehicleInfoProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    SoaVehicleInfoProxy(SoaVehicleInfoProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , soaVehicleInfo(std::move(other.soaVehicleInfo))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    SoaVehicleInfoProxy& operator=(SoaVehicleInfoProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    fields::soaVehicleInfo soaVehicleInfo;
};
} /// namespace proxy
} /// namespace control
} /// namespace eevp
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SOAVEHICLEINFO_PROXY_H