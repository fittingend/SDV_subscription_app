...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : vcs_accrpedal_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_VCS_ACCRPEDAL_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_VCS_ACCRPEDAL_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit vcs_AccrPedal(para::com::ProxyInterface* interface) : mInterface(interface)
    {
...
public:
    ...
    /// @brief Constructor
    explicit nofityStatus(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    /// @brief Destructor
    virtual ~nofityStatus() = default;
    /// @brief
    nofityStatus(const nofityStatus& other) = delete;
    nofityStatus& operator=(const nofityStatus& other) = delete;
    /// @brief Move constructor
    nofityStatus(nofityStatus&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    /// @brief Move assignment
    nofityStatus& operator=(nofityStatus&& other) noexcept
    {
        mInterface = other.mInterface;
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
...
private:
    static void HandleMethodReturn(std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData)
    {
        auto* promise = static_cast<ara::core::Promise<nofityStatus::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            nofityStatus::Output output;
            deserializer.read(output.VCS_AccrPedal);
        ...
        delete static_cast<ara::core::Promise<nofityStatus::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"nofityStatus"};
};
} /// namespace methods
/// @uptrace{SWS_CM_00004}
class VCS_AccrPedalProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<VCS_AccrPedalProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<VCS_AccrPedalProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<VCS_AccrPedalProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<VCS_AccrPedalProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<VCS_AccrPedalProxy::HandleType> handleContainer;
    ...
    explicit VCS_AccrPedalProxy(HandleType& handle)
        : mHandle(handle)
        ...
        , nofityStatus(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~VCS_AccrPedalProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    VCS_AccrPedalProxy(VCS_AccrPedalProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    VCS_AccrPedalProxy& operator=(const VCS_AccrPedalProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    VCS_AccrPedalProxy(VCS_AccrPedalProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , vcs_AccrPedal(std::move(other.vcs_AccrPedal))
        , nofityStatus(std::move(other.nofityStatus))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    VCS_AccrPedalProxy& operator=(VCS_AccrPedalProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    methods::nofityStatus nofityStatus;
};
} /// namespace proxy
} /// namespace simulation
} /// namespace eevp
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_VCS_ACCRPEDAL_PROXY_H