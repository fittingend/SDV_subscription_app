...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SOAVEHICLEINFO_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SOAVEHICLEINFO_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit soaVehicleInfo(para::com::SkeletonInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    SoaVehicleInfoSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~SoaVehicleInfoSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    SoaVehicleInfoSkeleton(const SoaVehicleInfoSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    SoaVehicleInfoSkeleton& operator=(const SoaVehicleInfoSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    SoaVehicleInfoSkeleton(SoaVehicleInfoSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    SoaVehicleInfoSkeleton& operator=(SoaVehicleInfoSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        soaVehicleInfo = std::move(other.soaVehicleInfo);
        mInterface->SetE2EErrorHandler([this](const ara::com::e2e::E2EErrorDomain& errorCode, ara::com::e2e::DataID dataID, ara::com::e2e::MessageCounter messageCounter) {
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SOAVEHICLEINFO_SKELETON_H