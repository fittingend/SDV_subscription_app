...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : msginfosrv_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_MSGINFOSRV_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_MSGINFOSRV_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit T_MSGINFO(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    /// @brief Constructor
    explicit ems_MsgInfo(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<MsgInfoSrvProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<MsgInfoSrvProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<MsgInfoSrvProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<MsgInfoSrvProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<MsgInfoSrvProxy::HandleType> handleContainer;
    ...
    explicit MsgInfoSrvProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~MsgInfoSrvProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    MsgInfoSrvProxy(MsgInfoSrvProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    MsgInfoSrvProxy& operator=(const MsgInfoSrvProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    MsgInfoSrvProxy(MsgInfoSrvProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    MsgInfoSrvProxy& operator=(MsgInfoSrvProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_MSGINFOSRV_PROXY_H