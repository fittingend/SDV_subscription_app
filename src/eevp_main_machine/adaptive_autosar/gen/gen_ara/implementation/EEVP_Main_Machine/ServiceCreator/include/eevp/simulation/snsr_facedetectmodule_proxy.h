...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SNSR_FACEDETECTMODULE_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SNSR_FACEDETECTMODULE_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Destructor
    virtual ~getEmotion() = default;
    /// @brief
    getEmotion(const getEmotion& other) = delete;
    getEmotion& operator=(const getEmotion& other) = delete;
    /// @brief Move constructor
    getEmotion(getEmotion&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    getEmotion& operator=(getEmotion&& other) noexcept
    {
...
private:
    ...
    {
        auto* promise = static_cast<ara::core::Promise<getEmotion::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            getEmotion::Output output;
            deserializer.read(output.FDM_EmotionType);
        ...
        delete static_cast<ara::core::Promise<getEmotion::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"getEmotion"};
};
/// @uptrace{SWS_CM_00006}
class isRunning
{
...
private:
    static void HandleMethodReturn(std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData)
    {
        ...
        if (result == 0)
        {
            ...
            deserializer.read(output.FDM_ReturnCode);
            promise->set_value(output);
        }
        else
        {
...
class Snsr_FaceDetectModuleProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Snsr_FaceDetectModuleProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Snsr_FaceDetectModuleProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Snsr_FaceDetectModuleProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Snsr_FaceDetectModuleProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Snsr_FaceDetectModuleProxy::HandleType> handleContainer;
    ...
    ~Snsr_FaceDetectModuleProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Snsr_FaceDetectModuleProxy(Snsr_FaceDetectModuleProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Snsr_FaceDetectModuleProxy& operator=(const Snsr_FaceDetectModuleProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Snsr_FaceDetectModuleProxy(Snsr_FaceDetectModuleProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , getEmotion(std::move(other.getEmotion))
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Snsr_FaceDetectModuleProxy& operator=(Snsr_FaceDetectModuleProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SNSR_FACEDETECTMODULE_PROXY_H