...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_VCS_EPB_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_VCS_EPB_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Destructor
    virtual ~notifystaticSlope() = default;
    /// @brief
    notifystaticSlope(const notifystaticSlope& other) = delete;
    notifystaticSlope& operator=(const notifystaticSlope& other) = delete;
    /// @brief Move constructor
    notifystaticSlope(notifystaticSlope&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    notifystaticSlope& operator=(notifystaticSlope&& other) noexcept
    {
...
private:
    ...
    {
        auto* promise = static_cast<ara::core::Promise<notifystaticSlope::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            notifystaticSlope::Output output;
            deserializer.read(output.VCS_Slope);
        ...
        delete static_cast<ara::core::Promise<notifystaticSlope::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"notifystaticSlope"};
};
} /// namespace methods
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<VCS_EPBProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<VCS_EPBProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<VCS_EPBProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<VCS_EPBProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<VCS_EPBProxy::HandleType> handleContainer;
    ...
    explicit VCS_EPBProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , notifystaticSlope(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~VCS_EPBProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    VCS_EPBProxy(VCS_EPBProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    VCS_EPBProxy& operator=(const VCS_EPBProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    VCS_EPBProxy(VCS_EPBProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , notifystaticSlope(std::move(other.notifystaticSlope))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    VCS_EPBProxy& operator=(VCS_EPBProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    methods::notifystaticSlope notifystaticSlope;
};
} /// namespace proxy
} /// namespace simulation
} /// namespace eevp
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_VCS_EPB_PROXY_H