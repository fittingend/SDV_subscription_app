...
VehicleContext::VehicleContext()
{
	...
	this->mWiperOpMode = eWiperOpMode_Off;
	this->mVehicleSpeed = 0;
	this->mGear = eGearState_Unknown;
	this->mAcc = eAccState_Error;
	this->mIgn1 = eIgnState_Error;
	this->mIgn2 = eIgnState_Error;
}
...
std::string VehicleContext::DebugInfo()
{
	...
	ss << "VehicleContext:\n";
	ss << "- isNormal:" << getStringEnum_DeviceNormal_e(this->mDeviceNormal) << ", autoMode=" << (this->mAutoMode ? "True" : "False") << ", WiperOpMode=" << getStringEnum_WiperOpMode_e(this->mWiperOpMode) << "\n";
	return ss.str();
}