...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : vcs_brakeswitch_proxy.h
/// SERVICE INTERFACE NAME            : VCS_BrakeSwitch
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_VCS_BRAKESWITCH_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_VCS_BRAKESWITCH_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "vcs_brakeswitch_common.h"
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<VCS_BrakeSwitchProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<VCS_BrakeSwitchProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<VCS_BrakeSwitchProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<VCS_BrakeSwitchProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<VCS_BrakeSwitchProxy::HandleType> handleContainer;
    ...
    explicit VCS_BrakeSwitchProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~VCS_BrakeSwitchProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    VCS_BrakeSwitchProxy(VCS_BrakeSwitchProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    VCS_BrakeSwitchProxy& operator=(const VCS_BrakeSwitchProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    VCS_BrakeSwitchProxy(VCS_BrakeSwitchProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    VCS_BrakeSwitchProxy& operator=(VCS_BrakeSwitchProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_VCS_BRAKESWITCH_PROXY_H