...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_VCS_VEHSPD_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_VCS_VEHSPD_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<VCS_VehSpdProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<VCS_VehSpdProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<VCS_VehSpdProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<VCS_VehSpdProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<VCS_VehSpdProxy::HandleType> handleContainer;
    ...
    ~VCS_VehSpdProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    VCS_VehSpdProxy(VCS_VehSpdProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    VCS_VehSpdProxy& operator=(const VCS_VehSpdProxy& other) = delete;
    /// @brief Move constructor
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    VCS_VehSpdProxy& operator=(VCS_VehSpdProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_VCS_VEHSPD_PROXY_H