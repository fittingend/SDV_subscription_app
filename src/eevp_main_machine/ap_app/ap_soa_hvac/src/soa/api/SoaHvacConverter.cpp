...
// AirSource
eevp::control::SoaHvacAirSource Convert_AirSource_SOA2API(HvacAirSource_e airSrc)
{
	switch (airSrc)
	{
...
HvacAirSource_e Convert_AirSource_API2SOA(eevp::control::SoaHvacAirSource airSrc)
{
	switch (airSrc)
	{
...
// BlowDir
eevp::control::SoaHvacBlowDir Convert_BlowDir_SOA2API(HvacBlowDir_e blowDir)
{
	switch (blowDir)
	{
...
HvacBlowDir_e Convert_BlowDir_API2SOA(eevp::control::SoaHvacBlowDir blowDir)
{
	switch (blowDir)
	{
...
void Convert_HvacStatus_SOA2API(const HvacStatus_t &src, eevp::control::SoaHvacStatus &dst)
{
	...
	dst.blowingDir = Convert_BlowDir_SOA2API(src.mBlowDir);
	dst.airSrc = Convert_AirSource_SOA2API(src.mAirSrc);
...
void Convert_HvacStatus_API2SOA(const eevp::control::SoaHvacStatus &src, HvacStatus_t &dst)
{
	...
	dst.mBlowDir = Convert_BlowDir_API2SOA(src.blowingDir);
	dst.mAirSrc = Convert_AirSource_API2SOA(src.airSrc);
