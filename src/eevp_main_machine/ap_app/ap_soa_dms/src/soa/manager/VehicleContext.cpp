...
VehicleContext::VehicleContext()
{
	...
	this->mPowerOn = false;
	this->mDriverInside = eDmsDriverInside_Unknown;
	this->mGazingDir = eDmsGazingDir_Unknown;
	this->mFatigue = eDmsFatigue_Unknown;
	this->mIsOnPhone = eDmsOnPhone_Unknown;
	this->mIsSmoking = eDmsSmoking_Unknown;
...
std::string VehicleContext::DebugInfo()
{
	...
	ss << "VehicleContext:\r\n";
	ss << "- mDeviceNormal : " << getStringEnum_DeviceNormal_e(this->mDeviceNormal) << "\n";
	ss << "- mPowerOn : " << getStringEnum_bool(this->mPowerOn) << "\n";
	ss << "- mDriverInside : " << getStringEnum_DmsDriverInside_e(this->mDriverInside) << "\n";
	ss << "- mGazingDir : " << getStringEnum_DmsGazingDir_e(this->mGazingDir) << "\n";
	ss << "- mFatigue : " << getStringEnum_DmsFatigue_e(this->mFatigue) << "\n";
	ss << "- mIsOnPhone : " << getStringEnum_DmsOnPhone_e(this->mIsOnPhone) << "\n";
	ss << "- mIsSmoking : " << getStringEnum_DmsSmoking_e(this->mIsSmoking) << "\n";
	ss << "- mSwVersion : " << (int)this->mSwVersion << "\n";
	return ss.str();
}
