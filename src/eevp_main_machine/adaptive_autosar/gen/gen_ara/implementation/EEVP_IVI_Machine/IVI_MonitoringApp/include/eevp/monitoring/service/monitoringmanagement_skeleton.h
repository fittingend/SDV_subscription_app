...
public:
    ...
    struct ResetRoaDetectInfoOutput
    {
    };
    struct SetRoaModeOutput
    {
    };
    struct SetWiperAutoSpeedOutput
    {
    };
    struct StartRoaOutput
    {
    };
    struct StopRoaOutput
    {
    };
        ...
        , soaWiperSwVersion(mInterface.get())
    {
        ...
        mInterface->SetMethodCallHandler(kResetRoaDetectInfoCallSign, [this](const std::vector<std::uint8_t>& data, const para::com::MethodToken token) {
            HandleResetRoaDetectInfo(data, token);
        });
...
public:
    ...
    /// @uptrace{SWS_CM_00191}
    virtual ara::core::Future<ResetRoaDetectInfoOutput> ResetRoaDetectInfo() = 0;
    /// @brief Method, SetRoaMode
    /// @uptrace{SWS_CM_00191}
    virtual ara::core::Future<SetRoaModeOutput> SetRoaMode(const eevp::control::SoaRoaMode& mode) = 0;
    ...
    /// @uptrace{SWS_CM_00191}
    virtual ara::core::Future<StartRoaOutput> StartRoa() = 0;
    /// @brief Method, StopRoa
    /// @uptrace{SWS_CM_00191}
    virtual ara::core::Future<StopRoaOutput> StopRoa() = 0;
...
private:
    ...
    void HandleResetRoaDetectInfo(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        std::uint8_t retResult{1};
        std::vector<std::uint8_t> retData{};
        auto future = ResetRoaDetectInfo();
        auto result = future.GetResult();
        if (result.HasValue())
        {
            retResult = 0;
        ...
        mInterface->ReturnMethod(kResetRoaDetectInfoCallSign, retResult, retData, token);
    }
    void HandleSetRoaMode(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        std::uint8_t retResult{1};
        std::vector<std::uint8_t> retData{};
        para::serializer::Deserializer deserializer{data};
        ...
        mInterface->ReturnMethod(kSetRoaModeCallSign, retResult, retData, token);
    }
    ...
    void HandleStartRoa(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        std::uint8_t retResult{1};
        std::vector<std::uint8_t> retData{};
        auto future = StartRoa();
        auto result = future.GetResult();
        if (result.HasValue())
        {
            retResult = 0;
        ...
        mInterface->ReturnMethod(kStartRoaCallSign, retResult, retData, token);
    }
    void HandleStopRoa(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        std::uint8_t retResult{1};
        std::vector<std::uint8_t> retData{};
        auto future = StopRoa();
        ...
        mInterface->ReturnMethod(kStopRoaCallSign, retResult, retData, token);
    }
