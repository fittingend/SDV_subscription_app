...
std::string VehicleContext::DebugInfo()
{
	...
	ss << "VehicleContext:\r\n";
	ss << "- deviceNormal : " << getStringEnum_DeviceNormal_e(this->mDeviceNormal) << "\n";
	ss << "- autoMode : " << getStringEnum_bool(this->mAuto) << "\n";
	ss << "- opacities : " << getString_SmtfilmOpacities_t(this->mOpacities) << "\n";
	return ss.str();
}