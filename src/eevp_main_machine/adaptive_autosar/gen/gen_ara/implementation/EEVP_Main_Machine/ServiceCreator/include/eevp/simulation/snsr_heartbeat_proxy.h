...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : snsr_heartbeat_proxy.h
/// SERVICE INTERFACE NAME            : Snsr_Heartbeat
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SNSR_HEARTBEAT_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SNSR_HEARTBEAT_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "snsr_heartbeat_common.h"
...
public:
    ...
    struct Output
    {
        std::uint32_t hrStatus;
    };
    /// @brief Constructor
    explicit getHr(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    /// @brief Destructor
    virtual ~getHr() = default;
    /// @brief
    getHr(const getHr& other) = delete;
    getHr& operator=(const getHr& other) = delete;
    /// @brief Move constructor
    getHr(getHr&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    getHr& operator=(getHr&& other) noexcept
    {
...
private:
    ...
    {
        auto* promise = static_cast<ara::core::Promise<getHr::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            getHr::Output output;
            deserializer.read(output.hrStatus);
        ...
        delete static_cast<ara::core::Promise<getHr::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"getHr"};
};
} /// namespace methods
/// @uptrace{SWS_CM_00004}
class Snsr_HeartbeatProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Snsr_HeartbeatProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Snsr_HeartbeatProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Snsr_HeartbeatProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Snsr_HeartbeatProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Snsr_HeartbeatProxy::HandleType> handleContainer;
    ...
    explicit Snsr_HeartbeatProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , getHr(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~Snsr_HeartbeatProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Snsr_HeartbeatProxy(Snsr_HeartbeatProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Snsr_HeartbeatProxy& operator=(const Snsr_HeartbeatProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Snsr_HeartbeatProxy(Snsr_HeartbeatProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , getHr(std::move(other.getHr))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Snsr_HeartbeatProxy& operator=(Snsr_HeartbeatProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SNSR_HEARTBEAT_PROXY_H