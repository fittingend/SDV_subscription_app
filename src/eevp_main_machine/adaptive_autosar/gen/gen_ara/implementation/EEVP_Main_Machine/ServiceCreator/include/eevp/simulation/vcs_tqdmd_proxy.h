...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : vcs_tqdmd_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_VCS_TQDMD_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_VCS_TQDMD_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit setDrivePedalPosn(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    /// @brief Destructor
    virtual ~setDrivePedalPosn() = default;
    /// @brief
    setDrivePedalPosn(const setDrivePedalPosn& other) = delete;
    setDrivePedalPosn& operator=(const setDrivePedalPosn& other) = delete;
    /// @brief Move constructor
    setDrivePedalPosn(setDrivePedalPosn&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    setDrivePedalPosn& operator=(setDrivePedalPosn&& other) noexcept
    {
    ...
    /// @uptrace{SWS_CM_00196}
    ara::core::Future<Output> operator()(const std::uint16_t& drivePedalPosn)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(drivePedalPosn);
...
private:
    ...
    {
        auto* promise = static_cast<ara::core::Promise<setDrivePedalPosn::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            setDrivePedalPosn::Output output;
        ...
        delete static_cast<ara::core::Promise<setDrivePedalPosn::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"setDrivePedalPosn"};
};
} /// namespace methods
/// @uptrace{SWS_CM_00004}
class VCS_TqDmdProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<VCS_TqDmdProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<VCS_TqDmdProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<VCS_TqDmdProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<VCS_TqDmdProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<VCS_TqDmdProxy::HandleType> handleContainer;
    ...
    explicit VCS_TqDmdProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , setDrivePedalPosn(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~VCS_TqDmdProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    VCS_TqDmdProxy(VCS_TqDmdProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    VCS_TqDmdProxy& operator=(const VCS_TqDmdProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    VCS_TqDmdProxy(VCS_TqDmdProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , setDrivePedalPosn(std::move(other.setDrivePedalPosn))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    VCS_TqDmdProxy& operator=(VCS_TqDmdProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    methods::setDrivePedalPosn setDrivePedalPosn;
};
} /// namespace proxy
} /// namespace simulation
} /// namespace eevp
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_VCS_TQDMD_PROXY_H