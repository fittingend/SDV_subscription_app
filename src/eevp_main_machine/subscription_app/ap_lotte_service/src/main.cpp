...
consumer::aa::Consumer* g_swcConsumer{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcConsumer->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("COSM", "Consumer's main function")};
        ...
        consumer::aa::Consumer swcConsumer;
        g_swcConsumer = &swcConsumer;
        
        // initialize software component
        proceed = swcConsumer.Initialize();
