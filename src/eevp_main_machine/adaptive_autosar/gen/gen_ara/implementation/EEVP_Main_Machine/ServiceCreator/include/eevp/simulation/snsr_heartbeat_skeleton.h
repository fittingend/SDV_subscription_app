...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : snsr_heartbeat_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SNSR_HEARTBEAT_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SNSR_HEARTBEAT_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    Snsr_HeartbeatSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
        : mInterface(std::make_unique<para::com::SkeletonInterface>(instanceSpec, mode))
    {
        mInterface->SetMethodCallHandler(kgetHrCallSign, [this](const std::vector<std::uint8_t>& data, const para::com::MethodToken token) {
            HandlegetHr(data, token);
        });
    ...
    /// @brief Destructor
    virtual ~Snsr_HeartbeatSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    Snsr_HeartbeatSkeleton(const Snsr_HeartbeatSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    Snsr_HeartbeatSkeleton& operator=(const Snsr_HeartbeatSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    Snsr_HeartbeatSkeleton(Snsr_HeartbeatSkeleton&& other) noexcept
    ...
    /// @uptrace{SWS_CM_00135}
    Snsr_HeartbeatSkeleton& operator=(Snsr_HeartbeatSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        mInterface->SetMethodCallHandler(kgetHrCallSign, [this](const std::vector<std::uint8_t>& data, const para::com::MethodToken token) {
            HandlegetHr(data, token);
...
public:
    /// @brief Method, getHr
    /// @uptrace{SWS_CM_00191}
    virtual ara::core::Future<getHrOutput> getHr() = 0;
    
private:
    void HandlegetHr(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        ...
        if (result.HasValue())
        {
            getHrOutput output = result.Value();
            para::serializer::Serializer serializer{};
            serializer.write(output.hrStatus);
        ...
        mInterface->ReturnMethod(kgetHrCallSign, retResult, retData, token);
    }
    const std::string kgetHrCallSign{"getHr"};
};
} /// namespace skeleton
} /// namespace simulation
} /// namespace eevp
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SNSR_HEARTBEAT_SKELETON_H