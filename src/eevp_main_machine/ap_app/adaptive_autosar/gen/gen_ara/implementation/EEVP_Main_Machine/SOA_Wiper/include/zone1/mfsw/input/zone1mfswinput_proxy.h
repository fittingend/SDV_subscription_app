...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : zone1mfswinput_proxy.h
/// SERVICE INTERFACE NAME            : Zone1MfswInput
/// GENERATED DATE                    : 2025-07-01 18:02:13
///////////////////////////////////////////////////////////////////////////////////////////////////////////
///                                                                                                        
/// CAUTION!! AUTOMATICALLY GENERATED FILE - DO NOT EDIT                                                   
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE1MFSWINPUT_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE1MFSWINPUT_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "zone1mfswinput_common.h"
...
public:
    ...
    using SampleType = zone::input::type::ZoneByteVectorType;
    /// @brief Constructor
    explicit onMfswInput(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
    virtual ~onMfswInput() = default;
    /// @brief Delete copy constructor
    onMfswInput(const onMfswInput& other) = delete;
    /// @brief Delete copy assignment
    onMfswInput& operator=(const onMfswInput& other) = delete;
    /// @brief Move constructor
    onMfswInput(onMfswInput&& other) noexcept : mInterface(other.mInterface)
    {
    ...
    onMfswInput& operator=(onMfswInput&& other) noexcept
    {
...
private:
    ...
    const std::string kCallSign = {"onMfswInput"};
};
} /// namespace events
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Zone1MfswInputProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Zone1MfswInputProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Zone1MfswInputProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Zone1MfswInputProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Zone1MfswInputProxy::HandleType> handleContainer;
    ...
    explicit Zone1MfswInputProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , onMfswInput(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~Zone1MfswInputProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Zone1MfswInputProxy(Zone1MfswInputProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Zone1MfswInputProxy& operator=(const Zone1MfswInputProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Zone1MfswInputProxy(Zone1MfswInputProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , onMfswInput(std::move(other.onMfswInput))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Zone1MfswInputProxy& operator=(Zone1MfswInputProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    /// @brief - event, onMfswInput
    events::onMfswInput onMfswInput;
};
} /// namespace proxy
} /// namespace input
} /// namespace mfsw
} /// namespace zone1
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE1MFSWINPUT_PROXY_H